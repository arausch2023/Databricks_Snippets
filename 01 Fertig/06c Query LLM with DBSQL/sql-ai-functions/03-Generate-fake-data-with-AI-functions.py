...
# MAGIC To run this demo, just select the cluster `dbdemos-sql-ai-functions-arausch` from the dropdown menu ([open cluster configuration](https://adb-3456974533129641.1.azuredatabricks.net/#setting/clusters/0706-110803-f0gi0j7w/configuration)). <br />
# MAGIC *Note: If the cluster was deleted after 30 days, you can re-create it with `dbdemos.create_cluster('sql-ai-functions')` or re-install the demo: `dbdemos.install('sql-ai-functions')`*
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2FDBSQL%2Fsql-ai-functions%2F03-Generate-fake-data-with-AI-functions&cid=3456974533129641&uid=790552050668208">
