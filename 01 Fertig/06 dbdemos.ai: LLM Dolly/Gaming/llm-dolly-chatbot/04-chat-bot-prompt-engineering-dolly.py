...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-dolly-chatbot-arausch` from the dropdown menu ([open cluster configuration](https://adb-3456974533129641.1.azuredatabricks.net/#setting/clusters/0706-063354-ume5nzzn/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fllm-dolly-chatbot%2F04-chat-bot-prompt-engineering-dolly&cid=3456974533129641&uid=790552050668208">
...
def build_qa_chain():
  ...
  template = """You are a chatbot having a conversation with a human. Your are asked to answer gaming questions.
...
class ChatBot():
  ...
  def reset_context(self):
    ...
    displayHTML("<h1>Hi! I'm a chat bot specialized in gaming. How Can I help you today?</h1>")
  ...
  def chat(self, question):
    ...
    for d in result["input_documents"]:
      ...
      result_html += f"<p><blockquote>{d.page_content}<br/>(Source: <a href=\"https://gaming.stackexchange.com/a/{source_id}\">{source_id}</a>)</blockquote></p>"
...
chat_bot.chat("What is the best class for beginners in Divinity Original Sin 2?")

# COMMAND ----------

chat_bot.chat("What are the best starting attributes?")
