...
os.environ['OPENAI_API_KEY'] = dbutils.secrets.get("openai_key_secret_scope", "openai_key_secret_key")
...
config['openai_key_secret_scope'] = "openai_key_secret_scope" # See `./RUNME` notebook for secret scope instruction - make sure it is consistent with the secret scope name you actually use 
config['openai_key_secret_key'] = "openai_key_secret_key" # See `./RUNME` notebook for secret scope instruction - make sure it is consistent with the secret scope key name you actually use
