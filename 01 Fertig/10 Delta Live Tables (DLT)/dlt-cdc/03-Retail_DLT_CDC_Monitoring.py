...
# MAGIC To run this demo, just select the cluster `dbdemos-dlt-cdc-arausch` from the dropdown menu ([open cluster configuration](https://adb-3456974533129641.1.azuredatabricks.net/#setting/clusters/0706-095600-tstfh5t1/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F03-Retail_DLT_CDC_Monitoring&cid=3456974533129641&uid=790552050668208">
...
# MAGIC
# MAGIC We can start creating our first <a href="/sql/dashboards/b1c5a13a-694d-4dc7-bfe0-baf335ae0dc6" target="_blank">DBSQL Dashboard</a> monitoring our data quality & DLT pipeline health.
