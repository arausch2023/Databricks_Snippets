...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F02-Retail_DLT_CDC_Python&cid=3456974533129641&uid=790552050668208">
...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/0422db04-fc30-4fa6-a558-4323dfc03b85">Delta Live Table Pipeline for CDC</a>.
...
# MAGIC %md
# MAGIC ## Conclusion 
# MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/0422db04-fc30-4fa6-a558-4323dfc03b85">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
# MAGIC
# MAGIC <a href="/sql/dashboards/b1c5a13a-694d-4dc7-bfe0-baf335ae0dc6" target="_blank">Data Quality Dashboard</a>
